...
<ul class="nav navbar-nav navbar-right">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"></span> <i class="fa-solid fa-user-plus"></i> Sign Up <span class="caret"></span> </a>
...
?>
    ...
    <div class="wide">
        ...
        <div class="col-xs-5 line"></div>
        <div class="tagline">MAA Food DeliverY</div>
    </div>
    <br>
