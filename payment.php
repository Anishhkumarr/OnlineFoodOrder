...
?>
           <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><i class="fa-solid fa-user"></i> Welcome <?php echo $_SESSION['login_user1']; ?> </a></li>
...
<ul class="nav navbar-nav navbar-right">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-door-open"></i> Sign Up <span class="caret"></span> </a>
...
<h1 class="text-center">
  <a href="cart.php"><button class="btn btn-warning"><i class="fa-sharp fa-solid fa-arrow-left"></i> Go back to cart</button></a>
  <a href="onlinepay.php"><button class="btn btn-success"><i class="fa-regular fa-credit-card"></i> Pay Online</button></a>
