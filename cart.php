...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><i class="fa-solid fa-cart-shopping"></i>  Cart
             (<?php
...
<?php
  echo '<a href="cart.php?action=empty"><button class="btn btn-danger"><i class="fa-solid fa-trash"></i> Empty Cart</button></a>&nbsp;<a href="foodlist.php"><button class="btn btn-warning">Continue Shopping</button></a>&nbsp;<a href="payment.php"><button class="btn btn-success pull-right"><i class="fa-solid fa-square-check"></i> Check Out</button></a>';
?>
</div>
